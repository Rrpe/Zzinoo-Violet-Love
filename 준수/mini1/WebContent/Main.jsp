...
function javascript(){
    ...
    window.open('레이어팝업2.jsp', 'popName', 'width=300, height=350, top=100, left=100, toolbar=no, menubar=no, location=no, scrollbars=no, resizable=no, fullscreen=no, status=no');
}
</script>
</head>
