		...
		<header class="blog-header py-3">
			<div
				...
				<div class="col-4 text-center" align="center">
					<a class="blog-header-logo text-dark" href="Main.jsp"><h1>Violet
							Love</h1> </a>
				</div>
				<div class="col-4 d-flex justify-content-end align-items-center">
					...
					</a> <a class="btn btn-sm btn-outline-secondary" onclick="page_href()">Search</a>
					<!--/////// Search -->
					<%
					...
					<%
						}else { System.out.println("세션값 있음");
					%>
						<a class="btn btn-sm btn-outline-secondary" href="Login.jsp">logout</a>
					<%
						}
					%>
				</div>
				...
				<div class="col-md-6">
					<div class="card flex-md-row mb-4 shadow-sm h-md-250">
						<div class="card-body d-flex flex-column align-items-start">
							...
							<p>So baby pull me closer in the backseat of your Rover That
								I know you can't afford Bite that tattoo on your shoulder Pull
								the sheets right off the corner Of the mattress that you stole
								From your roommate back in Boulder We ain't ever getting older</p>
						</div>
					</div>
				</div>
				<div class="col-md-6">
		...
		<div class="col-md-8 blog-main">
			<div class="blog-post">
				<div style="overflow: auto;">
					<img src="image/noname01.bmp"><br> <img
						src="image/다운로드.jpg"><br> <img src="image/sky1.png"><br>
