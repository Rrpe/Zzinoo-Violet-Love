...
////////// 상수 //////////
var SIZE_MIDIUM = "m";    //중급
 
var ROW_SIZE_MIDIUM = 4;    //중급 가로 블럭 갯수
var COL_SIZE_MIDIUM = 4;    //중급 세로 블럭 갯수
...
function initGame(size) {
  ...
  if (size == SIZE_MIDIUM) {      //중급
    rowSize = ROW_SIZE_MIDIUM;
    colSize = COL_SIZE_MIDIUM;
  } 
...
<div id="debugDiv"></div>
<embed src = "sounds/bg1.mp3" autostart ="true" loop="true" width ="280"height="25"  hidden="true">
</body>
</html>