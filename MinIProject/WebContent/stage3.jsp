...
var ROW_SIZE_BIG = 6;    //고급 가로 블럭 갯수
var COL_SIZE_BIG = 6;    //고급 세로 블럭 갯수
...
<!-- 게임 시작과 끝 블럭 -->
<button onclick="startGame();"style = center>
...
<div id="debugDiv"></div>
 <embed src = "sounds/bg1.mp3" autostart ="false" loop="true" width ="280"height="25"  hidden="true">
</body>
</html>