		...
		<header class="blog-header py-3">
			<div
				...
				<div class="col-4 text-center" align="center">
					<a class="blog-header-logo text-dark" href="Mainlist.do"><h1>Violet
							Love</h1> </a>
				</div>
				<div class="col-4 d-flex justify-content-end align-items-center">
					...
					<%
						if (session.isNew()) { // 세션이 생성될때
							session.setAttribute("idSession", request.getParameter("userID")); // 세션의 login의 값인 홍길동을 넘겨준다
