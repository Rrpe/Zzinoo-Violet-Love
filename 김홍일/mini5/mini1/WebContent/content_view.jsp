...
<div class="container">
		...
		<form action="modify.do" method="post" enctype="Multipart/form-data">
			...
			<tr>
				<td> 이름 </td>
				<td> <input type="text" name="userID" value="${content_view.userID}" size = "50"></td>
			</tr>
			<tr>
				<td> 제목 </td>
			...
			<tr>
				<td> 내용 </td>
				<td> <textarea name="bContent" class="form-control" rows="3" cols="3">${content_view.bContent}</textarea></td>
			</tr>
			<tr>
				<td> 파일명 </td>
