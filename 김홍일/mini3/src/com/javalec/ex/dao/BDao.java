...
public class BDao {  // DAO 데이터베이스에 접근하여 작업을 해준다
	...
	public void modify(String bId, String bName, String bTitle, String bContent, String namee) {
		// TODO Auto-generated method stub
		...
		try {
			...
			String query = "update mvc_board set bName = ?, bTitle = ?, bContent = ?, namee = ? where bId = ?";
			preparedStatement = connection.prepareStatement(query);
			preparedStatement.setString(1, bName);
			preparedStatement.setString(2, bTitle);
			preparedStatement.setString(3, bContent);
